...
export default () => {
  ...
  const allMyArrays2: Array<Array<string|number>> = [sequence, animals, stringsAndNumbers];

  console.log('Exercise 1.5', allMyArrays);
  console.log('Exercise 1.5 Alternative', allMyArrays2);
